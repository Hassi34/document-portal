...
from utils.exception.custom_exception import DocumentPortalException
...
class DocumentHandler:
    ...
    def __init__(self,data_dir=None,session_id=None):
        try:
            ...
            config = load_config()
            default_data_dir = config.get("data", {}).get("storage", {}).get("document_analysis", "data/document_analysis")
